...
define('NavigationHelper', ['Session', 'UrlHelper'], function (Session)
{
	...
	var NavigationHelper = {
		...
		mountToApp: function (application)
		{
			...
			,	getTargetTouchpoint: function ($target)
				{
					...
					new_url = this.fixTargetHost(new_url, target_data.touchpoint !== application.getConfig('currentTouchpoint'));
			...
			,	fixTargetHost: function (url, navigating_to_diff_touchpoint)
				{
					var fixed_url = url;
					...
					if(!~url.indexOf('https:'))
					{
						...
						if (navigating_to_diff_touchpoint)
						{
